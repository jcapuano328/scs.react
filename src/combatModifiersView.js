    ...
    render() {
        return (
            <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-start'}}>
                ...
                <View style={{flex: 1}}>
                    <SpinNumeric value={this.props.attack} min={1} max={500} onChanged={this.props.onChangeAttack} />
                </View>
                <View style={{flex: 1}}>
                    <SpinNumeric value={this.props.defend} min={1} max={500} onChanged={this.props.onChangeDefend} />
                </View>
            </View>
        );
    }
